          ...
          <div className="left">
            ...
            <div className="item">
              ...
              <div className="details">
                <h1 className="itemTitle">{data?.response[5].username} </h1>
                <div className="detailItem">
                  <span className="itemKey">Website:</span>
                  <span className="itemValue">{data?.response[5].website}</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Due Diligence Folder:</span>
                  <span className="itemValue">{data?.response[5].DueDiligence}</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Loan Amount:</span>
                  <span className="itemValue">
                  {data?.response[5].funded_amount}
                  </span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Interest rate:</span>
                  <span className="itemValue">{data?.response[5].InterestRate}</span>
                </div>
                <div className="detailItem">
